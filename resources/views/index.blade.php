    ...
    <div class="w-full h-full dark:bg-neutral-900/80 flex justify-center items-center">
      <div class="w-2xl p-5 md:text-left text-center">
        ...
        <div class="flex gap-5 justify-center md:justify-normal">
          <p>// <a href="{{ route('schedule-index') }}" class="text-gray-400 hover:text-teal-400 transition-colors underline underline-offset-3">Grafik</a></p>
          <p>// <a href="{{ route('key-dashboard') }}" class="text-gray-400 hover:text-teal-400 transition-colors underline underline-offset-3"> Keys</a></p>
          <p>// <a href="{{ route('about') }}" class="text-gray-400 hover:text-teal-400 transition-colors underline underline-offset-3">For HeadHunters</a>
        </div>
      </div>
    </div>
  </div>
