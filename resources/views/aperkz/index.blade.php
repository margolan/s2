...
<head>
  ...
  <title>www.aper.kz</title>
</head>

<body>

  <div class="w-full h-screen bg-gray-800 flex items-center justify-center">
    <div class="w-90 flex flex-col items-center">
      <div class="w-70 bg-white rounded-full">
        <img src="/uoFXe.png" alt="aper.kz">
      </div>
