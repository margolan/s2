@foreach ($actualSchedule as $index => $depart)
  <h2 class="font-semibold text-gray-800 dark:text-gray-200 px-1 py-4">{{ Str::upper($index) }}</h2>
  <div class="WRAP SCHEDULE max-w-max text-sm flex text-gray-300 p-3 mb-5 bg-zinc-800 rounded-lg" x-data="{ hoverIndex: null }">
